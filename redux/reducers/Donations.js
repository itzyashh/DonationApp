...
const Doantions = createSlice({
  name: 'donations',
  initialState,
  reducers: {
    resetDonations: () => initialState,
    setSelectedDonationId: (state, action) => {
      state.selectedDonationId = action.payload;
    },
  },
});

export const {resetDonations, setSelectedDonationId} = Doantions.actions;

export default Doantions.reducer;
